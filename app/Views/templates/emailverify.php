...
<div class="content mr-3 mb-5 mt-5">
    <form method="post" action="<?= base_url("emailverify/" . $key) ?>" class="container col-md-4">
        <input type="hidden" class="csrf_token" name="<?php echo csrf_token(); ?>" value="<?php echo csrf_hash(); ?>">
        <div class="form-group">
            <div class="pb-5 pt-5 text-center font-weight-bold">Please enter the verification code sent to your email</div>
